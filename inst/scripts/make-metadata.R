...
df_Visium_humanDLPFC <- cbind(
  ...
  TaxonomyId = "9606", 
  RDataPath = "STexampleData/3_20/Visium_humanDLPFC.rds", 
  BiocVersion = "3.15", 
...
df_Visium_mouseCoronal <- cbind(
  ...
  TaxonomyId = "10090", 
  RDataPath = "STexampleData/3_20/Visium_mouseCoronal.rds", 
  BiocVersion = "3.15", 
  RDataClass = "SpatialExperiment", 
  DispatchClass = "Rds", 
  stringsAsFactors = FALSE
...
df_Janesick_breastCancer_Chromium <- cbind(
  ...
  Species = "Homo sapiens", 
  TaxonomyId = "9606", 
  RDataPath = "STexampleData/3_20/Janesick_breastCancer_Chromium.rds", 
  BiocVersion = "3.19", 
...
df_Janesick_breastCancer_Visium <- cbind(
  ...
  Species = "Homo sapiens", 
  TaxonomyId = "9606", 
  RDataPath = "STexampleData/3_20/Janesick_breastCancer_Visium.rds", 
  BiocVersion = "3.19", 
  RDataClass = "SpatialExperiment", 
  DispatchClass = "Rds", 
  stringsAsFactors = FALSE
