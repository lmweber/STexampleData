...
load_data <- function(dataset_name, path = "tmp", delete = TRUE) {
  ...
  if (dataset_name == "Visium_humanDLPFC") {
    url <- "https://www.dropbox.com/s/9zllzxwmcjul8x8/Visium_humanDLPFC.RData?dl=1"
  } else if (dataset_name == "Visium_mouseCoronal") {
    url <- "https://www.dropbox.com/s/eut4gbwgxgbtni4/Visium_mouseCoronal.RData?dl=1"
  } else if (dataset_name == "seqFISH_mouseEmbryo") {
    url <- "https://www.dropbox.com/s/ei0aywt4kn005h0/seqFISH_mouseEmbryo.RData?dl=1"
  }
