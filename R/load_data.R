...
load_data <- function(dataset_name, path = "tmp", delete = TRUE) {
  ...
  if (dataset_name == "Visium_humanDLPFC") {
    url <- "https://www.dropbox.com/s/z05tqo5aj6qshfw/Visium_humanDLPFC.RData?dl=1"
  } else if (dataset_name == "Visium_mouseCoronal") {
    url <- "https://www.dropbox.com/s/d0g6y2n1a32cqq1/Visium_mouseCoronal.RData?dl=1"
  } else if (dataset_name == "seqFISH_mouseEmbryo") {
    url <- "https://www.dropbox.com/s/qv1o596j3zw8wpj/seqFISH_mouseEmbryo.RData?dl=1"
  }
